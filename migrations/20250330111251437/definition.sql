...
--
-- Class AppTheme as table app_theme
--
...
--
-- Class User as table fixie_user
--
CREATE TABLE "fixie_user" (
    ...
    "fcmToken" text,
    "hasPassedGoalTutorial" boolean,
    "informationCollectionSetting" boolean,
    "automaticRemindersSetting" boolean,
    "archetype" bigint,
    "limitedOfferEndTime" timestamp without time zone,
    "hasReviewed" boolean
);
...
--
-- Class PurchaseItem as table purchase_item
--
...
--
-- Class UserLocales as table user_locales
--
...
--
-- Foreign relations for "fixie_user" table
--
...
--
-- Foreign relations for "purchase_item" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('fixie', '20250330111251437', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250330111251437', "timestamp" = now();
